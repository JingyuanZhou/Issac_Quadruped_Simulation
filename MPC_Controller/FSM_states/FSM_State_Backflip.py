...
from MPC_Controller.FSM_states.BackFlipCtrl import BackFlipCtrl
...
class FSM_State_Backflip(FSM_State):
    ...
    def ComputeCommand(self):
        if self._b_first_visit:
            self.backflip_ctrl_.FirstVisit(self._curr_time)
            self._b_first_visit=False

        self.backflip_ctrl_.OneStep(self._curr_time,False,self._data._legController.commands)
    ...
    def checkTransition(self):
        ...
        * @return the enumerated FSM state name to transition into
        ...
        if Parameters.control_mode is FSM_StateName.BACKFLIP:
            pass
